...
function Product() {
  return (
    <>
      <div
        className="product"
        style={{ fontFamily: "sans-serif", fontSize: "1rem", marginTop:"4rem"}}
      >
        <div className="">
          <div className="row">
            <div className="col">
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      <div className="card-text text-white">
                        ...
                        <p>1.LINUX intelligent system</p>
                        <p>2.RAM128M+ROM256M</p>
                        <p> 3.4G recorder</p>
                        <p>4. Main control: Spreadtrum SL8521E</p>
                        <p> 5. Front lens 1080P GC2053 Gekewei</p>
                        <p> 6. Pull back lens 1080P AHD4005</p>
                        <p>
                          {" "}
                          7.WIFI, support remote live broadcast and remote
                          monitoring
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="card-text">
                        ...
                        <p>1.LINUX intelligent system</p>
                        <p> 2.RAM256M+ROM512M</p>
                        <p>3.4G recorder</p>
                        <p>4. Main control: Spreadtrum SL8521E</p>
                        <p>5.2-inch display</p>
                        <p> 6. Front lens 1080P GC2053 Gekewei</p>
                        <p> 7. Pull back lens 1080P AHD4005</p>
                        <p>
                          {" "}
                          8.WIFI, support remote live broadcast and remote
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      <div className="card-text text-white">
                          ...
                          <p> FVC-030 blind radar system,best aftermarket blind spot
                          detection system 2022</p>
        ...
        <div className="" style={{ marginTop: "2rem", marginBottom:"3rem" }}>
          <div className="row">
            <div className="col">
              <div className="card" style={{ backgroundColor: "#8e918f" }}>
                <div className="card-body">
